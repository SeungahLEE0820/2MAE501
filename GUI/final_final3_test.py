...
#Check if there is something in the queue
      while True:
          if queue:
              ...
              if x[0] == "0.00":
                  ...
                  data11.append(x[0],x[10])
                  data12.append(x[1],x[11])
                  data13.append(x[2],x[12])
                  t1+=1
                  time1.append(t1)
                  if x[3] == "0": 
              ...
              if x[5] == "0.00":
                  ...
                  data21.append(x[5],x[13])
                  data22.append(x[6],x[14])
                  data23.append(x[7],x[15])
                  t2+=1
                  time2.append(t2)
                  if x[8] == "0": 
   ...
   def Showplots(self):
        ...
        for t1 in range(len(time1)):
           for t1,tp1 in range(len(data11)):
             a.plot(data11[t1,tp1],time1[t1])
           for p1,pp1 in range(len(data12)):
             b.plot(data12[p1,pp1],time1[t1])
           for p1,pp1 in range(len(data12)):
             c.plot(data13[h1,hp1],time1[t1])
