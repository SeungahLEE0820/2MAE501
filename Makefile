bme280:main.o bme280.o majority.o
	gcc -Wall -o bme280 main.o bme280.o majority.o -lpthread -lwiringPi -std=gnu99
...
majority.o: majority.c
	gcc -Wall -c majority.c -std=gnu99
clean:
